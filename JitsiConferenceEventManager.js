...
JitsiConferenceEventManager.prototype.setupChatRoomListeners = function() {
    ...
    this.chatRoomForwarder.forward(XMPPEvents.MUC_ROOM_ALL_FEATURES_CHANGED,
        JitsiConferenceEvents.ROOM_ALL_FEATURES_CHANGED);
    ...
    this.chatRoomForwarder.forward(XMPPEvents.VIDEO_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS,
        JitsiConferenceEvents.VIDEO_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS);

    this.chatRoomForwarder.forward(XMPPEvents.RAISE_HAND_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS,
        JitsiConferenceEvents.RAISE_HAND_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS);
    ...
    this.chatRoomForwarder.forward(XMPPEvents.MICROPHONE_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS,
        JitsiConferenceEvents.MICROPHONE_ACCESS_CHANGED_FOR_ALL_PARTICIPANTS);
